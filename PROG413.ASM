...
; Program Description: To implement the bubble sort algorithm
; Date Created: November 8, 2024

;COMMENT | Bubble sort procedure BBLSORT.ASM 
...
.DATA
        ...
        text1 db 'Filename: Prog413.ASM$'
        text2 db 'Programmer Name: JOHN DYMIER O. BORGONIA$'
        text3 db 'To implement the bubble sort algorithm.$'
